...
TAG_PREFIX = "logistique-subtheme"


@cli
def migrate_bouquets(slug: str = "", dry_run: bool = False, env: str = "ecospheres/migrations/data/logistique/env.yaml"):
    """
    Remove "subtheme" tags from bouquets.
    """
    ...
    for bouquet in bouquets:
        ...
        if not any(t.startswith(TAG_PREFIX) for t in bouquet["tags"]):
            print("No subtheme tag to remove, skipping.")
            continue
